...
class Main {
    public static void main(String[] args) {
        무기 a무기 = new 칼();
        // 무기 타입 객체와만 연결할 수 있는 변수 a무기에
        // 칼 설계도로 만든 새로운 객체와 연결할 수 있는 리모콘을 준다.
        // 이때, 칼 설계도는 무기 설계도와 같은 모양을 하기 위해 형변환이 이루어지며
        // 무기 설계도에는 함수가 없기 떄문에 공격() 함수가 사라진다.

        // 무기 설계도 처럼 쓰인 칼은 공격 함수가 사라졌기 떄문에 함수를 사용할 수 없다.
        a무기.공격();
    }
}
